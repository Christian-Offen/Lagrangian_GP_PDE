...
function PDEContinueProgressBar(Ld, u0, u1; time_steps = 5)
...
function DiscreteEL(Ld,uStencil)
	u,uup,uleft,udown,uright,uupleft,udownright = uStencil
	return DiscreteEL(Ld,u,udown,uleft,uupleft,uup,uright,udownright)
